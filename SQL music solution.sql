...
--Q4. Which city has the best customers ? We would like to throw a promotional music festival in the city we made the most money . write a query that return one city that has the highest sum of invoice totals. Return both the city name & sum of all invoice totals.
...
--Q7. Return all the track names that have a song length longer than the average song lenght. Return the name and milliseconds for each track . Order by the song lenght with the longest songs listed first.
